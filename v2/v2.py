...
class Ui_MainWindow(object):
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.vvsum_5.setText(_translate("MainWindow", "Введите стоимость недвижимости"))
        ...
        def raschet(self):
                ...
                try:
                        ...
                        self.pereplata.setText('Ошибкааа')
                ...
                try:
                        ...
                        self.vsegred.setText('Ошибкааа')
                        self.pereplata.setText('Ошибкааа')
                        s = s + 'Стоимость введена некорректно\n '
                if perv>=ipoteca:
                        self.sinmred.setText('Ошибкааа')
                        self.vsegred.setText('Ошибкааа')
                        self.pereplata.setText('Ошибкааа')
                        s = s + 'Первый взнос больше стоимости\n '
                if not (self.diff.isChecked() and self.annuit.isChecked()):
                        self.sinmred.setText('Пипец')
                        self.vsegred.setText('Пипец')
                        self.pereplata.setText('Пипец')
                        s = s + 'Тип платежей не выбран\n '
                
                comboValue = self.comboBox.currentText()
                print (comboValue)
                if (perv != -1 and procenty != -1 and srok != -1 and ipoteca != -1 and perv<ipoteca):
                        cymma = ipoteca - perv
